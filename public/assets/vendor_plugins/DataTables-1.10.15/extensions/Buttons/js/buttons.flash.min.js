(function(g) {
            ...
            if (g.isPlainObject(d)) v(d);
                ...
                if (n) {
                    ...
                    for (e = c.attributes.length - 1; 0 <= e; e--) {
                        ...
                        var j = c.attributes[e].nodeValue; - 1 !== f.indexOf(":") && (h.push({
                            name: f,
                            value: j
                        }), c.removeAttribute(f))
                    }
                    e = 0;
                    for (f = h.length; e < f; e++) j = d.createAttribute(h[e].name.replace(":", "_dt_b_namespace_token_")), j.value = h[e].value, c.setAttributeNode(j)
                }
    ...
    var w = function(a, b) {
        ...
        x = function(a, b) {
            for (var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), h = b.escapeChar !== p ? b.escapeChar : "\\", j = function(a) {
                    ...
                    return b
                }, l = b.header ? j(c.header) + d : "", k = b.footer && c.footer ? d + j(c.footer) : "", m = [], u = 0, B = c.body.length; u < B; u++) m.push(j(c.body[u]));
            return {
                str: l + m.join(d) + k,
                rows: m.length
            }
        ...
        t = "",
        t = "undefined" === typeof j.XMLSerializer ? new function() {
    ...
    i.ext.buttons.excelFlash = g.extend({}, s, {
        ...
        action: function(a, b, d, c) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            ...
                            for (var n = 0, o = y.length; n < o; n++)
                                if (i = y[n], a[b].match && !a[b].match(/^0\d+/) && a[b].match(i.match)) {
                                    k = a[b].replace(/[^\d\.\-]/g, "");
                                    i.fmt && (k = i.fmt(k));
                                    k = m(f, "c", {
                                        attr: {
                            ...
                            k || ("number" ===
                                ...
                                }) : (i = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), k = m(f, "c", {
                                    attr: {
                                        t: "inlineStr",
                                        r: d
                                    },
            ...
            k = 0;
            for (n = b.header.length; k < n; k++) i.appendChild(m(f, "col", {
                attr: {
                    min: k + 1,
                    max: k + 1,
                    width: z(b, k),
