...
<head>
  ...
  <title>News | Global Market Trade</title>
...
<div class="alert alert-info">UI placeholder untuk News/Announcement.</div>
<div class="panel-group" id="newsAcc">
  <div class="panel panel-default" style="border-color:#333;">
    <div class="panel-heading" style="background:#222;">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#n1" class="text-white">Welcome to Global Market Trade</a>
      </h4>
    </div>
    <div id="n1" class="panel-collapse collapse in">
      <div class="panel-body text-muted">Konten berita/announcement akan tampil di sini.</div>
    </div>
  </div>
  <div class="panel panel-default" style="border-color:#333;">
    <div class="panel-heading" style="background:#222;">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#n2" class="text-white">System Maintenance</a>
      </h4>
    </div>
    <div id="n2" class="panel-collapse collapse">
      <div class="panel-body text-muted">Detail maintenance.</div>
    </div>
  </div>
</div>
