...
<head>
  ...
  <title>Generation | Global Market Trade</title>
...
<div class="wrapper">
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Generation Tree</h3>
  </div>
  <div class="box-body">
    
<div class="alert alert-info">
  UI placeholder untuk generation. Bisa nanti dibuat tree chart, tapi untuk sekarang list dulu.
</div>
<table class="table table-dark table-bordered table-hover w-100 gdt">
  <thead>
    <tr>
      <th>User</th><th>Parent</th><th>Level</th><th>Joined</th>
    </tr>
  </thead>
  <tbody></tbody>
</table>
