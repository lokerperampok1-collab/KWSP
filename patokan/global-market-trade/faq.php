...
<head>
  ...
  <title>FAQ | Global Market Trade</title>
  ...
  <div class="panel panel-default" style="border-color:#333;">
    <div class="panel-heading" style="background:#222;">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#f1" class="text-white">How to deposit?</a>
      </h4>
    </div>
    <div id="f1" class="panel-collapse collapse in">
      <div class="panel-body text-muted">Buka Wallet → Deposit → input amount.</div>
    </div>
  </div>
  <div class="panel panel-default" style="border-color:#333;">
    <div class="panel-heading" style="background:#222;">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#f2" class="text-white">How to withdraw?</a>
      </h4>
    </div>
    <div id="f2" class="panel-collapse collapse">
      <div class="panel-body text-muted">Buka Wallet → Withdrawal → ikuti instruksi.</div>
    </div>
  </div>
</div>
