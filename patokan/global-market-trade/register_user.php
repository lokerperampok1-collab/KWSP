...
<head>
  ...
  <title>Register User | Global Market Trade</title>
...
<div class="row">
  <div class="col-lg-6 col-12">
    <div class="form-group">
      ...
      <input type="text" class="form-control bg-dark text-white" style="border-color:#333;">
    </div>
    <div class="form-group">
      <label>Email</label>
      <input type="email" class="form-control bg-dark text-white" style="border-color:#333;">
    </div>
    <div class="form-group">
      <label>Password</label>
      <input type="password" class="form-control bg-dark text-white" style="border-color:#333;">
    </div>
    <button class="btn btn-warning">Create</button>
    <p class="text-muted mt-2 mb-0">UI placeholder (admin).</p>
  </div>
</div>
