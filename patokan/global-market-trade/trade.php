...
<head>
  ...
  <title>Trade | Global Market Trade</title>
...
<div class="wrapper">
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Open Trade</h3>
  </div>
  <div class="box-body">
...
<div class="row">
  <div class="col-lg-4 col-12">
    <div class="form-group">
      ...
      <select class="form-control bg-dark text-white" style="border-color:#333;">
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input type="number" class="form-control bg-dark text-white" placeholder="Enter Amount">
      </div>
    </div>
    <div class="form-group">
      <label>Direction</label>
      <div>
        <label class="mr-3"><input type="radio" name="dir" checked> Buy</label>
        <label><input type="radio" name="dir"> Sell</label>
      </div>
    </div>
    <button class="btn btn-warning btn-block">Start Trade</button>
    <div class="alert alert-info mt-3 mb-0">
      <strong>Notice:</strong><br>UI only. Backend trade will be connected later.
    </div>
  </div>
  <div class="col-lg-8 col-12">
    <table class="table table-dark table-bordered table-hover w-100 gdt">
      <thead>
        <tr>
          <th>Ticket</th><th>Date</th><th>Pair</th><th>Dir</th><th>Amount</th><th>Status</th>
        </tr>
      </thead>
      <tbody></tbody>
    </table>
