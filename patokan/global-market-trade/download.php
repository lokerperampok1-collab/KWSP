...
<head>
  ...
  <title>Download | Global Market Trade</title>
...
<div class="tv-ticker-wrap" style="margin:10px 0;">
  ...
  <div class="col-md-6 col-12">
    <div class="box" style="border:1px solid #333;">
      <div class="box-body d-flex justify-content-between align-items-center">
        <div>
          <h4 class="text-white mb-1">Company Profile</h4>
          <p class="text-muted mb-0">PDF</p>
        </div>
        <a class="btn btn-warning" href="#"><i class="fa fa-download"></i> Download</a>
      </div>
    </div>
  </div>
  <div class="col-md-6 col-12">
    <div class="box" style="border:1px solid #333;">
      <div class="box-body d-flex justify-content-between align-items-center">
        <div>
          <h4 class="text-white mb-1">Marketing Kit</h4>
